...
namespace NekoOdyssey.Scripts.Game.Unity.Audios
{
    ...
    public class NekoAudioEventEmitter : MonoBehaviour //  FMODUnity.EventHandler
    {
...
//         }
//
//         private static void RegisterActiveEmitter(NekoAudioEventEmitter emitter)
//         {
...
//         }
//
//         private static void DeregisterActiveEmitter(NekoAudioEventEmitter emitter)
//         {
...
//                                 instance.set3DAttributes(RuntimeUtils.To3DAttributes(target.gameObject, rigidBody));
...
//                                 instance.set3DAttributes(RuntimeUtils.To3DAttributes(target.gameObject, rigidBody2D));
